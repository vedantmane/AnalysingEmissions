...
barplot(names(data), data, xlab = "Year", ylab = "PM2.5 Emissions", xlim = c(1998,2008), ylim = range(data), type = "p",main = "Total PM2.5 emissions accross the years", pch = 19, col = "orangered")
